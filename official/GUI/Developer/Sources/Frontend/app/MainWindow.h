...
#include "dialogs/PhoneticParamsDialog.h"
#include "dialogs/AnatomyParamsDialog.h"
#include "dialogs/TdsOptionsDialog.h"
#include "dialogs/FdsOptionsDialog.h"
#include "dialogs/LfPulseDialog.h"
#include "dialogs/SpectrumOptionsDialog.h"
#include "dialogs/GlottisDialog.h"
#include "dialogs/VocalTractDialog.h"
#include "dialogs/AnalysisResultsDialog.h"
#include "dialogs/AnnotationDialog.h"
#include "dialogs/PoleZeroDialog.h"
...
private:
  ...
  void OnSegmentSequenceFileToAudio(wxCommandEvent& event);
  ...
  void OnSegToWavFiles(wxCommandEvent& event);

  void OnHertzToSemitones(wxCommandEvent &event);

  void OnAbout(wxCommandEvent &event);
  void OnExperiment1(wxCommandEvent& event);
  void OnExperiment2(wxCommandEvent& event);
  void OnTest1(wxCommandEvent& event);
  void OnTest2(wxCommandEvent& event);
  void OnTrxTryEstimation(wxCommandEvent& event);
