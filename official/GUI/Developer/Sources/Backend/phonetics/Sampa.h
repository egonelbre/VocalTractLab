...
{
public:
  // List of primary articulators for consonants.
  enum Articulator
  {
    ARTICULATOR_NONE,
    ARTICULATOR_LIP,
    ARTICULATOR_TONGUE_TIP,
    ARTICULATOR_TONGUE_BODY,
    ARTICULATOR_GLOTTIS
  };
  ...
  static string getVoicelessVersion(const string& symbol);
  static string getPlaceOfArticulation(const string& symbol);
  static string getMannerOfArticulation(const string& symbol);
  static Articulator getPrimaryArticulator(const string& symbol);
};
