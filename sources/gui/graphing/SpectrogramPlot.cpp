...
#include "graphing/SpectrogramPlot.h"
#include <iostream>
#include <limits>
...
{
  windowLength_pt = (int)(0.006*AUDIO_SAMPLING_RATE_HZ);
  ...
  Signal16 *s, int firstSample, int numSamples)
{
  ...
  int numVisSpectrumPoints = (viewRange_Hz*frameLength) / (double)AUDIO_SAMPLING_RATE_HZ;
