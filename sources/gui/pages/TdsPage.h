...
private:
  ...
  void OnCalcSubglottalImpedance(wxCommandEvent& event);
  void OnCalcSupraglottalImpedance(wxCommandEvent& event);
  void OnCalcTransferFunction(wxCommandEvent& event);
