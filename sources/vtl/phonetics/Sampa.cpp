...
string Sampa::getVoicelessVersion(const string& symbol)
{
  string x = symbol;

  if (symbol == "v") { x = "f"; }
  else if (symbol == "D") { x = "T"; }
  else if (symbol == "z") { x = "s"; }
  else if (symbol == "Z") { x = "S"; }
  else if (symbol == "j") { x = "C"; }
  else if (symbol == "R") { x = "x"; }
  else if (symbol == "b") { x = "p"; }
  else if (symbol == "d") { x = "t"; }
  else if (symbol == "g") { x = "k"; }
...
string Sampa::getPlaceOfArticulation(const string& symbol)
{
  string placeOfArticulation = "";

  if (symbol == "b" || symbol == "p" || symbol == "m")
  {
    placeOfArticulation = "bilabial";
  }
  else if (symbol == "f" || symbol == "v")
  {
    placeOfArticulation = "labio-dental";
  }
  else if (symbol == "T" || symbol == "D")
  {
  ...
  else if (symbol == "S" || symbol == "Z")
  {
    placeOfArticulation = "postalveolar";
  }
  else if (symbol == "C" || symbol == "j")
  {
    placeOfArticulation = "palatal";
  }
  else if (symbol == "k" || symbol == "g" ||
    symbol == "N" ||
    symbol == "x" || symbol == "R")
  {
    placeOfArticulation = "velar";
  }
  else if (symbol == "?" || symbol == "h")
  {
...
string Sampa::getMannerOfArticulation(const string& symbol)
{
  string mannerOfArticulation = "";
  
  if (isVowel(symbol))
  {
    mannerOfArticulation = "vowel";
  }
  else if (isFricative(symbol))
  {
    mannerOfArticulation = "fricative";
  }
  else if (isPlosive(symbol))
  {
    mannerOfArticulation = "plosive";
  }
  else if (isNasal(symbol))
  {
    mannerOfArticulation = "nasal";
  }
  else if (isLateral(symbol))
  {
    mannerOfArticulation = "lateral";
  }

  return mannerOfArticulation;
}


// ****************************************************************************
// Resturns the primary articulator of a consonant (or ARTICULATOR_NONE for
// vowels).
// ****************************************************************************

Sampa::Articulator Sampa::getPrimaryArticulator(const string& symbol)
{
  Articulator articulator = ARTICULATOR_NONE;

  if (symbol == "b" || symbol == "p" || symbol == "m" || 
      symbol == "f" || symbol == "v" || symbol == "pf")
  {
    articulator = ARTICULATOR_LIP;
  }
  else 
  
  if (symbol == "t" || symbol == "d" || symbol == "T" || symbol == "D" || 
    symbol == "s" || symbol == "z" || symbol == "S" || symbol == "Z" || 
    symbol == "ts" || symbol == "tS" || symbol == "dZ" || symbol == "n" || symbol == "l")
  {
    articulator = ARTICULATOR_TONGUE_TIP;
  }
  else 
    
  if (symbol == "k" || symbol == "g" || symbol == "C" || symbol == "j" ||
    symbol == "x" || symbol == "r" || symbol == "R" || symbol == "N")
  {
    articulator = ARTICULATOR_TONGUE_BODY;
  }
  else 
    
  if (symbol == "h" || symbol == "?")
  {
    articulator = ARTICULATOR_GLOTTIS;
  }
